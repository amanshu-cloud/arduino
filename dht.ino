...
const char* ssid = "Redmi"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "123456788"; // Your Wifi password, in case you have open network comment the whole statement.
...
void loop() {
  ...
  Serial.print(hif);
  Serial.println(F("°F"));
  if(request.indexOf("/get_value") != -1){
